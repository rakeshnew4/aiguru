...
class Settings(BaseSettings):
    ...
    # FASTER: Fastest models for simple tasks (formatting, image search)
    FASTER_PROVIDER: str = "bedrock"  # bedrock, gemini, groq
    FASTER_MODEL_ID: str = "anthropic.claude-3-haiku-20240307-v1:0"
    FASTER_TEMPERATURE: float = 0.5
    FASTER_MAX_TOKENS: int = 2048
