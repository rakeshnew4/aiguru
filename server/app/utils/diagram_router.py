...
_DIAGRAM_KEYWORD_MAP: dict[str, str] = {
    ...
    " vs ": "comparison",
    "compare": "comparison",
    # Flow / cycle — route to custom so LLM draws a real process diagram instead of boxes-in-a-ring
    ...
    "newton first law":       "anatomy",
    "newton second law":      "anatomy",
    "newton third law":       "anatomy",
    "newton laws of motion":  "anatomy",
    "laws of motion":         "anatomy",
    ...
    "gravitational force":    "anatomy",
    "free fall":              "anatomy",
    "projectile motion":      "anatomy",
    "pressure in fluids":     "anatomy",
    "archimedes principle":   "anatomy",
    "buoyancy":               "anatomy",
    "work done formula":      "anatomy",
    "kinetic energy":         "graph_function",
    "potential energy":       "graph_function",
    "power formula":          "anatomy",
    ...
    "reflection of light":    "anatomy",
    "refraction of light":    "anatomy",
    "convex lens":            "anatomy",
    "concave lens":           "anatomy",
    "electric circuit":       "anatomy",
    "series circuit":         "anatomy",
    "parallel circuit":       "comparison",
    "ohm law":                "anatomy",
    "magnetic field lines":   "anatomy",
    "electromagnet":          "anatomy",
    ...
    "valency":                "anatomy",
    "carbon compounds":       "anatomy",

    # ── CBSE Biology (Grades 6–10) ────────────────────────────────────────────
    "animal cell":            "anatomy",
    "plant cell":             "anatomy",
    "cell membrane":          "anatomy",
    "cell organelles":        "anatomy",
    "mitochondria":           "anatomy",
    "chloroplast":            "anatomy",
    "nucleus structure":      "anatomy",
