...
blackboard_prompt = (
    ...
    "summary  -> Bullet-point recap. ONLY for the very last frame of the lesson.\n\n"
    "INTERACTIVE QUIZ RULES:\n"
    "- Include 1-2 quiz_mcq frames per lesson.\n"
    "- quiz_mcq: Exactly 4 plausible options. Only one correct at quiz_correct_index (0, 1, 2, or 3).\n"
    ...
    "  - concept frame → tts_engine=google,  voice_role=teacher   (premium, natural explanation)\n"
    "  - memory frame  → tts_engine=google,  voice_role=teacher   (premium, catchy mnemonic)\n"
    "  - summary frame → tts_engine=google,  voice_role=teacher (neural, cost-efficient recap)\n"
    "  - quiz_mcq frames → tts_engine=android, voice_role=quiz     (instant, no latency)\n"
