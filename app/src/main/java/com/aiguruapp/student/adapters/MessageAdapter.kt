...
import com.aiguruapp.student.TutorController
...
class MessageAdapter(
    ...
    /** Single Markwon instance — handles bold/italic/tables/strikethrough/code/headings/LaTeX. */
    private val markwon: Markwon = Markwon.builder(context)
        .usePlugin(MarkwonInlineParserPlugin.create()) // must be first — required by JLatexMathPlugin
        .usePlugin(JLatexMathPlugin.create(
            android.util.TypedValue.applyDimension(
                android.util.TypedValue.COMPLEX_UNIT_SP, 16f,
